  ...
  tabPanel("About the Project",
    tags$div(id='about',
            ...
            tags$ol(
              ...
              tags$li("The most expensive Seattle homes for sale are found in ", most.expensive.neighborhood$Neighborhood, 
                      'with an average cost of $', most.expensive.neighborhood$Zindex, '.'),
              tags$li('The least expensive Seattle homes for sale are found in ', least.expensive.neighborhood$Neighborhood,
                      'with an average cost of $', least.expensive.neighborhood$Zindex, '.'), 
